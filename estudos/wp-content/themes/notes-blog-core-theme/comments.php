...
<?php if ( have_comments() ) : ?>
	<h2 id="comments"><?php comments_number(_e('No comments posted yet', 'notesblog'), _e('One single comment', 'notesblog'), _e('% comments', 'notesblog') );?> <a name="comments"></a></h2>
...
<h3><?php comment_form_title(_e('Post a comment', 'notesblog'), _e('Post a comment to %s', 'notesblog')); ?> <a name="respond"></a></h3>
